...
parser_train.add_argument("--start_ch", type=int,
                    default=6,
                    help="Number of input channels of U-Net model")
parser_train.add_argument("--out_ch", type=int,
                    default=1,
                    help="Number of output channels of U-Net model")
...
parser_train.add_argument("--upconv", type=str2bool,
                          default=True,
                          help="Use up convolutions")
parser_train.add_argument("--residual", type=str2bool,
                    default=True,
                    help="Use residual connections")
parser_train.add_argument("--inc_rate", type=float,
                    default=2.,
                    help="The inc rate")
parser_train.add_argument("--dropout", type=float,
                    default=0.5,
                    help="Percentage of dropout")
parser_train.add_argument("--activation", default='relu',
                    help="The activation function")
parser_train.add_argument("--model_name", default='model',
                    help="The name(s) of the dataset(s) used")
...
parser_test.add_argument("--image_size", type=int, default=256,
                    help="Image size used for training (only the one dimension needed)")
parser_test.add_argument("--start_ch", type=int,
                    default=6,
                    help="Number of input channels of U-Net model")
parser_test.add_argument("--out_ch", type=int,
                    default=1,
                    help="Number of output channels of U-Net model")
parser_test.add_argument("--depth", type=int,
                    default=5,
                    help="Depth of U-Net model")
parser_test.add_argument("--print_model", type=str2bool,
                    default=True,
                    help="Print the model's configuration")
parser_test.add_argument("--batchnorm", type=str2bool,
                    default=True,
                    help="Use batch normalization")
parser_test.add_argument("--maxpool", type=str2bool,
                    default=True,
                    help="Use max pooling")
parser_test.add_argument("--upconv", type=str2bool,
                          default=True,
                          help="Use up convolutions")
parser_test.add_argument("--residual", type=str2bool,
                    default=True,
                    help="Use residual connections")
parser_test.add_argument("--inc_rate", type=float,
                    default=2.,
                    help="The learning rate for the training")
parser_test.add_argument("--dropout", type=float,
                    default=0.5,
                    help="Percentage of dropout")
parser_test.add_argument("--activation", default='relu',
                    help="The activation function")
parser_test.add_argument("--model_name", default='model',
                    help="The name(s) of the dataset(s) used")
